        ...
        try:
            ...
            if fbs.get()=='' or gen.get()==''or eia.get()=='':
                ...
                if int(predictions[0]) == 1:
                        warning = Label(canvas, text="Result : Positive", font=('times new roman', 16,'bold'), fg="yellow", bg="firebrick3", bd=10)
                        warning.place(x = 30,y = 405)
                        warning.after(4500, lambda: warning.destroy())
                        
                elif int(predictions[0]) == 0:
                        warning = Label(canvas, text="Result : Negative", font=('times new roman', 16,'bold'), fg="greenk", bg="firebrick3", bd=10)
                        warning.place(x = 30,y = 405)
                        warning.after(4500, lambda: warning.destroy())
